...
def main():
    pdb = cfr.ProxyDatabase().load_nc('./prev_data/lipd_pdb.nc')
    pdb.refresh()

    job = cfr.ReconJob()
    job.proxydb = pdb

    # additional filtering by archive to get closer to LMRv2.1
    ...
    job.load_clim(
        ...
        path_dict= {
        'tas': './data/ccsm4_last_millenium/tas_sfc_Amon_CCSM4_past1000_085001-185012.nc',
        'pr': './data/ccsm4_last_millenium/pr_sfc_Amon_CCSM4_past1000_085001-185012.nc'
        },
    ...
    job.save('./cases/lmr_reproduce_lipd', verbose=True)

    job.run_da_mc(
        save_dirpath='./recons/lmr_reproduce_lipd',
