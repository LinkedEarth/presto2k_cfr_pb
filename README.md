...
- [Step 2a](https://tanaya-g.github.io/pages2k_cfr_pb/notebooks/data_assembly/C02_a_DA_with_class_based_seasonality.html)  runs the DA with class-based seasonality. Only one instance is illustrated here (results obviously vary as a function of how Step 1 is implemented). 
- [Step 2b](https://tanaya-g.github.io/pages2k_cfr_pb/notebooks/data_assembly/C02_b_DA_with_individual_seasonality.html)  runs the DA with metadata-based seasonality. Once again, only one instance is illustrated in this notebook. 
